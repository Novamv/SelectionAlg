...
#Muon bug check
# time python run.py --input-correlations /sps/juno/mlecocq/Data/Physics/RUN.9789.JUNODAQ.Physics.ds-2.global_trigger.20250830113037.656_J25.5.0.rtraw \
# --input /sps/juno/mlecocq/Data/Physics/RUN.9789.JUNODAQ.Physics.ds-2.global_trigger.20250830113037.656_J25.5.0.esd \
# --output RUN9789_IBD.root --recEDMPath /Event/CdVertexRecOMILREC --loglevel Info
